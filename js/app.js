    ...
    (() => {
            ...
            if (spollersArray.length > 0) {
                ...
                if (spollersClose.length) document.addEventListener("click", (function(e) {
                    ...
                    if (!el.closest("[data-spollers]")) spollersClose.forEach((spollerClose => {
                        ...
                        spollerClose.parentNode.classList.remove("_active");
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                } else if ("name" === formRequiredItem.dataset.required) if (this.nameTest(formRequiredItem)) {
                    this.addError(formRequiredItem);
                    error++;
                } else this.removeError(formRequiredItem); else if ("tel" === formRequiredItem.dataset.required) if (this.telTest(formRequiredItem)) {
                    this.addError(formRequiredItem);
                    error++;
            ...
            nameTest(formRequiredItem) {
                return !/^[a-zA-Zа-яА-ЯЁё ]+$/.test(formRequiredItem.value);
            },
            telTest(formRequiredItem) {
                return !/^(\s*)?(\+)?([- _():=+]?\d[- _():=+]?){10,14}(\s*)?$/im.test(formRequiredItem.value);
            }
        };
        ...
        const sliders_width = window.innerWidth;
        function initSliders() {
            if (document.querySelector(".lineup__slider")) {
                if (sliders_width <= 1300.98) new core(".lineup__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
            ...
            if (document.querySelector(".periphery__slider")) if (sliders_width <= 991.98) new core(".periphery__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".gallery__slider")) {
                if (sliders_width > 767.98) new core(".gallery__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
            ...
            if (document.querySelector(".swiper-live__slider") && sliders_width > 1300.98) {
                document.querySelector(".swiper-live__slider--tablet").remove();
                new core(".swiper-live__slider--desktop", {
                    ...
                    navigation: {
                        prevEl: ".live-slider-prev",
                        nextEl: ".live-slider-next"
                    },
                    on: {}
                });
            }
            if (document.querySelector(".swiper-live__slider") && sliders_width <= 1300.98) {
                document.querySelector(".swiper-live__slider--desktop").remove();
                new core(".swiper-live__slider--tablet", {
                    modules: [ Mousewheel ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
            ...
            if (document.querySelector(".computers__slider")) if (sliders_width <= 991.98) new core(".computers__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".configuration__slider")) {
                if (sliders_width <= 1300.98) new core(".configuration__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".configuration-slider-prev",
                        nextEl: ".configuration-slider-next"
                    },
                    breakpoints: {
                        2: {
                            spaceBetween: 10
            ...
            if (document.querySelector(".slider-reviews")) {
                if (sliders_width <= 1300.98) new core(".slider-reviews", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
        ...
        const simplebar_width = window.innerWidth;
        if (simplebar_width > 991.98) if (document.querySelectorAll("[data-simplebar-desktop]").length) document.querySelectorAll("[data-simplebar-desktop]").forEach((scrollBlock => {
 ...
 */
        ...
        if (gallery_width > 767.98 && document.querySelector(".gallery__slider--mobile")) document.querySelector(".gallery__slider--mobile").remove();
        if (gallery_width <= 767.98 && document.querySelector(".gallery__slider--desktop")) document.querySelector(".gallery__slider--desktop").remove();
        let itemGallery = document.querySelector("[data-gallery]");
        if (itemGallery) {
            let itemGalleryImages = itemGallery.getElementsByClassName("gallery__image");
            ...
            let itemGalleryLight = lightgallery_es5(itemGallery, {
                dynamic: true,
                plugins: [ lgThumbnail ],
            ...
            for (let index = 0; index < itemGalleryImages.length; index++) {
                const element = itemGalleryImages[index];
                element.setAttribute("data-gallery-image-index", index);
            }
            itemGallery.addEventListener("click", (function(e) {
                let realIndexGalleryImage = Number(e.target.closest(".gallery__image").getAttribute("data-gallery-image-index"));
                itemGalleryLight.openGallery(realIndexGalleryImage);
            }));
        }
        ...
        da.init();
        const products_namespaceObject = JSON.parse('{"R":[{"id":5,"url":"#","series":"optima","title":"Optima Lvl 1","type":"Игровой компьютер","image":"img/configuration.png","price":"1361","cpu":"AMD 8/16X Ryzen 7 3700X 3.6-4.4GHz","motherboard":"AMD B450 ATX 4xDimm Gigabyte Pro","videoCard":"Gigabyte RTX 2060 Super 8Gb","ram":"G.Skill RGB 2x8Gb 3200MHz","power":"750W Gold DeepCool Quanta","hdd":"1000Gb Seagate 7200rpm Barracuda","ssd":"XPG SX8200 Pro 512Gb M.2"},{"id":6,"url":"#","series":"optima","title":"Optima Lvl 2","type":"Игровой компьютер","image":"img/configuration.png","price":"1520","cpu":"AMD 8/16X Ryzen 7 3700X 3.6-4.4GHz","motherboard":"AMD B450 ATX 4xDimm Gigabyte Pro","videoCard":"Gigabyte RTX 2070 Super 8Gb","ram":"G.Skill RGB 2x8Gb 3200MHz","power":"750W Gold DeepCool Quanta","hdd":"1000Gb Seagate 7200rpm Barracuda","ssd":"XPG SX8200 Pro 512Gb M.2"},{"id":7,"url":"#","series":"optima","title":"Optima Lvl 3","type":"Игровой компьютер","image":"img/configuration.png","price":"1680","cpu":"AMD 8/16X Ryzen 7 3700X 3.6-4.4GHz","motherboard":"AMD B450 ATX 4xDimm Gigabyte Pro","videoCard":"Gigabyte RTX 2080 Super 8Gb","ram":"G.Skill RGB 2x8Gb 3200MHz","power":"750W Gold DeepCool Quanta","hdd":"1000Gb Seagate 7200rpm Barracuda","ssd":"XPG SX8200 Pro 512Gb M.2"},{"id":8,"url":"#","series":"optima","title":"Optima Lvl 4","type":"Игровой компьютер","image":"img/configuration.png","price":"1790","cpu":"AMD 8/16X Ryzen 7 3700X 3.6-4.4GHz","motherboard":"AMD B450 ATX 4xDimm Gigabyte Pro","videoCard":"Gigabyte RTX 2080 Ti Super 11Gb","ram":"G.Skill RGB 2x8Gb 3200MHz","power":"G.Skill RGB 2x8Gb 3200MHz","hdd":"G.Skill RGB 2x8Gb 3200MHz","ssd":"XPG SX8200 Pro 512Gb M.2"}]}');
        ...
        const videoGenerate = video => {
            const btn = video.querySelector(".swiper-live__button");
            const videoID = btn.dataset.videoId;
            const container = video.querySelector(".swiper-live__video-item");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            var onPhoneInput = function(e) {
                ...
                if ([ "3" ].indexOf(inputNumbersValue[0]) > -1) {
                    var firstSymbols = "3" == inputNumbersValue[0] ? "+375" : "+375";
                    formattedInputValue = input.value = firstSymbols + "";
                    if ("37" == inputNumbersValue) formattedInputValue = "";
                    ...
                    firstSymbols = "8" == inputNumbersValue[0] ? "8" : "+7";
                    formattedInputValue = input.value = firstSymbols + " ";
        ...
        if (document.querySelector(".form-cart")) {
            ...
            document.addEventListener("click", (function(e) {
                if (e.target.closest(".form-buttons__next")) if (validateForm()) {
                    nextTab();
                    buttonActive();
                }
                if (e.target.closest(".submit-popup__button")) {
                    const emptyCart = document.querySelector(".empty-cart");
                    const cart = document.querySelector(".cart");
                    clearProducts();
                    basketUpdate();
                ...
                if (e.target.closest(".form-buttons__next")) if (e.target.closest('button[type="submit"]')) {
                    e.preventDefault();
                    if (validateForm()) flsModules.popup.open("#thanks");
                }
                if (e.target.closest(".form-buttons__prev")) {
                    prevTab();
                    buttonActive();
                }
            }));
            document.body.addEventListener("input", (function(e) {
                if ("INPUT" === e.target.tagName && e.target.hasAttribute("data-required") && document.querySelector(".form-cart")) {
                    const currentTab = document.querySelector(".form-cart__tab._tab-active");
                    const nextButton = currentTab.querySelector(".form-buttons__next");
                    const currentTabInputs = currentTab.querySelectorAll("[data-required]");
                    for (let i = 0; i < currentTabInputs.length; i++) if ("email" === currentTabInputs[i].dataset.required) {
                        if (emailTest(currentTabInputs[i])) {
                            nextButton.classList.remove("_active");
                            break;
                        }
                    } else if ("name" === currentTabInputs[i].dataset.required) {
                        if (nameTest(currentTabInputs[i])) {
                            nextButton.classList.remove("_active");
                            break;
                        }
                    } else if ("tel" === currentTabInputs[i].dataset.required) {
                        if (telTest(currentTabInputs[i])) {
                            nextButton.classList.remove("_active");
                            break;
                        }
                    } else if ("checkbox" === currentTabInputs[i].type && !currentTabInputs[i].checked) {
                        nextButton.classList.remove("_active");
                        break;
                    } else if (!currentTabInputs[i].value) {
                        nextButton.classList.remove("_active");
                        break;
                    } else nextButton.classList.add("_active");
                }
            }));
            const formTabs = document.querySelectorAll(".form-cart__tab");
            const formNavigationItems = document.querySelectorAll(".navigation-cart__item");
            formTabs[0].classList.add("_tab-active");
            formNavigationItems[0].classList.add("_active");
            buttonActive();
            function nextTab() {
                for (let i = 0; i <= formTabs.length; i++) {
                    if (formTabs[formTabs.length - 1].classList.contains("_tab-active")) break;
                    if (formTabs[i].classList.contains("_tab-active")) {
                        formTabs[i].classList.remove("_tab-active");
                        if (formTabs.length == formNavigationItems.length) formNavigationItems[i].classList.remove("_active");
                        if (formTabs[++i].querySelector(".form-confirmation__info")) copyInputs();
                        formTabs[i].classList.add("_tab-active");
                        if (formTabs.length == formNavigationItems.length) formNavigationItems[i].classList.add("_active");
                        break;
                    }
                }
            }
            function prevTab() {
                for (let i = 0; i < formTabs.length; i++) {
                    if (formTabs[0].classList.contains("_tab-active")) break;
                    if (formTabs[i].classList.contains("_tab-active")) {
                        formTabs[i].classList.remove("_tab-active");
                        if (formTabs.length == formNavigationItems.length) formNavigationItems[i].classList.remove("_active");
                        formTabs[--i].classList.add("_tab-active");
            ...
            function validateForm() {
                const currentTab = document.querySelector(".form-cart__tab._tab-active");
                const currentTabInputs = currentTab.querySelectorAll("[data-required]");
                if (currentTabInputs.length > 0) for (let i = 0; i < currentTabInputs.length; i++) formValidate.validateInput(currentTabInputs[i]); else if (0 == currentTabInputs.length) return true;
                if (currentTab.querySelectorAll("input._form-error").length > 0) return false; else if (0 == currentTab.querySelectorAll("input._form-error").length) return true;
            }
            function buttonActive() {
                const currentTab = document.querySelector(".form-cart__tab._tab-active");
                const nextButton = currentTab.querySelector(".form-buttons__next");
                const currentTabInputs = currentTab.querySelectorAll("[data-required]");
                if (0 == currentTabInputs.length) nextButton.classList.add("_active"); else if (currentTabInputs.length > 0) for (let i = 0; i < currentTabInputs.length; i++) if ("email" === currentTabInputs[i].dataset.required) {
                    if (emailTest(currentTabInputs[i])) {
                        nextButton.classList.remove("_active");
                        break;
                    }
            ...
            function copyInputs() {
                ...
                const paymentInputs = document.getElementById("payment").getElementsByTagName("input");
                const name = document.getElementById("name_2");
                const tel = document.getElementById("tel_2");
                const email = document.getElementById("email_2");
                const payment = document.getElementById("payment_2");
                name.innerText = nameValue;
                tel.innerText = telValue;
                if (emailValue) {
                    email.parentElement.classList.remove("_none");
                    email.innerText = emailValue;
                } else email.parentElement.classList.add("_none");
                let paymentInputsLabels = document.getElementById("payment").getElementsByTagName("label");
                let n;
                for (let i = 0; i < paymentInputs.length; i++) if (paymentInputs[i].checked) n = paymentInputs[i].getAttribute("id");
                for (let i = 0; i < paymentInputsLabels.length; i++) if (paymentInputsLabels[i].getAttribute("for") === n) payment.innerText = paymentInputsLabels[i].textContent;
                if (document.querySelector(".form-cart").dataset.free) document.getElementById("delivery").innerText = document.querySelector(".form-cart").dataset.free + ", " + cityValue + ", " + homeValue + ", " + indexValue; else document.getElementById("delivery").innerText = cityValue + ", " + homeValue + ", " + indexValue;
            }
            function emailTest(q) {
                return !/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,8})+$/.test(q.value);
            }
            function nameTest(q) {
                return !/^[a-zA-Zа-яА-ЯЁё ]+$/.test(q.value);
            }
            function telTest(q) {
                return !/^(\s*)?(\+)?([- _():=+]?\d[- _():=+]?){10,14}(\s*)?$/im.test(q.value);
            }
        }
        const configuration = document.querySelector(".configuration");
        if (configuration) if (configuration.dataset.series) {
            const wrapper = configuration.querySelector(".configuration__wrapper");
            let seriesProducts = products_namespaceObject.R.filter((function(item, index, array) {
                return item.series === configuration.dataset.series;
            }));
            for (let i = 0; i < seriesProducts.length; i++) {
                let productTemplate = `\n                <div data-pid="${seriesProducts[i].id}" class="configuration__slide swiper-slide configuration-column">\n                <a href="${seriesProducts[i].url}" class="configuration-column__image"><img src="${seriesProducts[i].image}" alt="image"></a>\n                <div class="configuration-column__title">${seriesProducts[i].title}</div>\n                <div class="configuration-column__item">\n                    <div class="configuration-column__logo _icon-cpu"></div>\n                    <div class="configuration-column__info">\n                        <div class="configuration-column__label">Поцессор:</div>\n                        <div class="configuration-column__subtitle">${seriesProducts[i].cpu}</div>\n                    </div>\n                </div>\n                <div class="configuration-column__item">\n                    <div class="configuration-column__logo _icon-motherboard"></div>\n                    <div class="configuration-column__info">\n                        <div class="configuration-column__label">Материнская плата:</div>\n                        <div class="configuration-column__subtitle">${seriesProducts[i].motherboard}</div>\n                    </div>\n                </div>\n                <div class="configuration-column__item">\n                    <div class="configuration-column__logo _icon-video-card"></div>\n                    <div class="configuration-column__info">\n                        <div class="configuration-column__label">Видеокарта:</div>\n                        <div class="configuration-column__subtitle">${seriesProducts[i].videoCard}</div>\n                    </div>\n                </div>\n                <div class="configuration-column__item">\n                    <div class="configuration-column__logo _icon-ram"></div>\n                    <div class="configuration-column__info">\n                        <div class="configuration-column__label">Оперативная память:</div>\n                        <div class="configuration-column__subtitle">${seriesProducts[i].ram}</div>\n                    </div>\n                </div>\n                <div class="configuration-column__item">\n                    <div class="configuration-column__logo _icon-ssd"></div>\n                    <div class="configuration-column__info">\n                        <div class="configuration-column__label">SSD диск:</div>\n                        <div class="configuration-column__subtitle">${seriesProducts[i].ssd}</div>\n                    </div>\n                </div>\n                <div class="configuration-column__item">\n                    <div class="configuration-column__logo _icon-hdd"></div>\n                    <div class="configuration-column__info">\n                        <div class="configuration-column__label">HDD диск:</div>\n                        <div class="configuration-column__subtitle">${seriesProducts[i].hdd}</div>\n                    </div>\n                </div>\n                <div class="configuration-column__item configuration-column__item--after-none">\n                    <div class="configuration-column__logo _icon-power"></div>\n                    <div class="configuration-column__info">\n                        <div class="configuration-column__label">Блок питания:</div>\n                        <div class="configuration-column__subtitle">${seriesProducts[i].power}</div>\n                    </div>\n                </div>\n                <div class="configuration-column__price"><span>${seriesProducts[i].price} $</span></div>\n                <div class="configuration-column__button configuration-column__button--add _active button">\n                    <a href="#" class="button__item"><span>Добавить в корзину</span></a>\n                </div>\n                <div class="configuration-column__button configuration-column__button--delete button">\n                    <a href="#" class="button__item"><span>Удалить из корзины</span></a>\n                </div>\n            </div>\n            `;
                wrapper.insertAdjacentHTML("beforeend", productTemplate);
            }
        }
        document.addEventListener("click", (function(e) {
            if (e.target.closest(".configuration-column__button--add")) {
                e.preventDefault();
                if (!e.target.classList.contains("_hold")) {
                    e.target.closest(".configuration-column__button--add").classList.add("_hold");
                    putProducts(e.target.closest(".configuration-column").dataset.pid);
                }
            }
            if (e.target.closest(".configuration-column__button--delete")) {
                e.preventDefault();
                removeProducts(e.target.closest(".configuration-column").dataset.pid);
            }
            if (e.target.closest(".order-list__delete")) {
                e.preventDefault();
                deleteProducts(e.target.closest(".order-list__item").dataset.pid);
            }
        }));
        function getProducts() {
            const productsLocalStorage = localStorage.getItem("products");
            if (null !== productsLocalStorage) return JSON.parse(productsLocalStorage);
            return [];
        }
        ...
        function productButoonActive() {
            if (document.querySelector(".configuration")) {
                let localProducts = getProducts();
                const products = document.querySelectorAll(".configuration__slide");
                for (let i = 0; i < products.length; i++) if (localProducts.includes(products[i].dataset.pid)) {
                    products[i].querySelector(".configuration-column__button--add").classList.remove("_active");
                    products[i].querySelector(".configuration-column__button--delete").classList.add("_active");
                } else {
                    products[i].querySelector(".configuration-column__button--add").classList.add("_active");
                    products[i].querySelector(".configuration-column__button--add").classList.remove("_hold");
                    products[i].querySelector(".configuration-column__button--delete").classList.remove("_active");
                }
            }
        }
        function basketUpdate() {
            if (document.querySelector(".cart-header")) {
                ...
                if (products.length) if (cartQuantity) cartQuantity.innerText = products.length; else cartIcon.insertAdjacentHTML("beforeend", `<span>${products.length}</span>`); else if (cartQuantity) cartQuantity.remove();
            }
        }
        if (document.querySelector(".cart")) {
            const emptyCart = document.querySelector(".empty-cart");
            const cart = document.querySelector(".cart");
            const cartList = document.querySelector(".form-order__items");
            const cartListCopy = document.querySelector(".form-confirmation__items");
            let products = getProducts();
            if (products.length) {
            ...
            function createProducts() {
                for (let i = 0; i < products.length; i++) {
                    let addedProducts = products_namespaceObject.R.find((function(item, index, array) {
                        return item.id === Number(products[i]);
                    }));
                    let productTemplate = `\n            <li data-pid="${addedProducts.id}" data-price="${addedProducts.price}" class="order-list__item">\n                <div class="order-list__delete"></div>\n                <button type="button" data-spoller class="order-list__content">\n                    <div class="order-list__icon _icon-arrow"></div>\n                    <div class="order-list__title">${addedProducts.type} ${addedProducts.title}</div>\n                    <div class="order-list__price">${addedProducts.price} $</div>\n                </button>\n                <div class="order-list__row">\n                    <div class="order-list__column">\n                        <div class="order-list__label">Процессор:</div>\n                        <div class="order-list__subtitle">${addedProducts.cpu}</div>\n                    </div>\n                    <div class="order-list__column">\n                        <div class="order-list__label">Материнская плата:</div>\n                        <div class="order-list__subtitle">${addedProducts.motherboard}</div>\n                    </div>\n                    <div class="order-list__column">\n                        <div class="order-list__label">Видео карта:</div>\n                        <div class="order-list__subtitle">${addedProducts.videoCard}</div>\n                    </div>\n                    <div class="order-list__column">\n                        <div class="order-list__label">Оперативная память:</div>\n                        <div class="order-list__subtitle">${addedProducts.ram}</div>\n                    </div>\n                    <div class="order-list__column">\n                        <div class="order-list__label">SSD Диск:</div>\n                        <div class="order-list__subtitle">${addedProducts.ssd}</div>\n                    </div>\n                    <div class="order-list__column">\n                        <div class="order-list__label">HDD диск:</div>\n                        <div class="order-list__subtitle">${addedProducts.hdd}</div>\n                    </div>\n                    <div class="order-list__column">\n                        <div class="order-list__label">Блок питания:</div>\n                        <div class="order-list__subtitle">${addedProducts.power}</div>\n                    </div>\n                </div>\n            </li>\n            `;
                    cartList.insertAdjacentHTML("beforeend", productTemplate);
                    cartListCopy.insertAdjacentHTML("beforeend", productTemplate);
                }
            }
        }
        function deleteProducts(id) {
            const emptyCart = document.querySelector(".empty-cart");
            const cart = document.querySelector(".cart");
            const cartListItems = document.querySelectorAll(".form-order__items .order-list__item");
            const cartListItemsCopy = document.querySelectorAll(".form-confirmation__items .order-list__item");
            let products = getProducts();
            const index = products.indexOf(id);
            products.splice(index, 1);
            localStorage.setItem("products", JSON.stringify(products));
            basketUpdate();
            for (let i = 0; i < cartListItems.length; i++) if (cartListItems[i].dataset.pid === id) {
                cartListItems[i].remove();
                cartListItemsCopy[i].remove();
                break;
            }
            totalPrice();
            if (!document.querySelectorAll(".form-order__items .order-list__item").length) {
                cart.classList.remove("active");
                emptyCart.classList.add("active");
            }
        }
        function totalPrice() {
            const cartListItems = document.querySelector(".form-order__items").getElementsByClassName("order-list__item");
            let totalPrice = 0;
            for (let i = 0; i < cartListItems.length; i++) if (cartListItems[i].dataset.price) totalPrice += Number(cartListItems[i].dataset.price);
            document.querySelector(".form-confirmation__total").querySelector("span").innerText = totalPrice;
        }
        productButoonActive();
        basketUpdate();
        const script_width = window.innerWidth;
        if (script_width > 991.98) if (document.querySelector(".configurator")) {
            document.addEventListener("click", (function(e) {
                if (e.target.closest(".navigation-configurator__item")) {
                    const configuratorNavigationItems = document.querySelectorAll(".navigation-configurator__item");
                    let currentNavigationItemId;
                    for (let i = 0; i < configuratorNavigationItems.length; i++) if (e.target.closest(".navigation-configurator__item") == configuratorNavigationItems[i]) {
                        currentNavigationItemId = i;
                        break;
                    }
                    if (configuratorNavigationItems[configuratorNavigationItems.length - 1] != e.target.closest(".navigation-configurator__item")) {
                        if (document.querySelector(".navigation-configurator__item._active")) document.querySelector(".navigation-configurator__item._active").classList.remove("_active");
                        configuratorNavigationItems[currentNavigationItemId].classList.add("_active");
                        const configuratorColumns = document.querySelectorAll(".navigation-configurator__columns");
                        for (let i = 0; i < configuratorColumns.length; i++) configuratorColumns[i].classList.remove("_active");
                        configuratorColumns[currentNavigationItemId].classList.add("_active");
                        configuratorListsActive();
                    }
                    if (configuratorNavigationItems[configuratorNavigationItems.length - 1] == e.target.closest(".navigation-configurator__item")) {
                        const contentConfigurator = document.querySelectorAll(".content-configurator");
                        const totalConfigurator = document.querySelector(".total-configurator");
                        for (let i = 0; i < contentConfigurator.length; i++) contentConfigurator[i].classList.remove("_active");
                        totalConfigurator.classList.add("_active");
                        totalActive();
                        totalPrice();
                    }
                }
                if (e.target.closest(".navigation-configurator__column")) {
                    const configuratorCurrentColumns = e.target.closest(".navigation-configurator__column").closest(".navigation-configurator__columns").querySelectorAll(".navigation-configurator__column");
                    for (let i = 0; i < configuratorCurrentColumns.length; i++) configuratorCurrentColumns[i].classList.remove("_active");
                    e.target.closest(".navigation-configurator__column").classList.add("_active");
                    configuratorListsActive();
                }
                if (e.target.closest(".main-configurator__list-item")) {
                    const confguratorItem = e.target.closest(".main-configurator__list-item");
                    const activeColumn = document.querySelector(".navigation-configurator__columns._active").querySelector(".navigation-configurator__column._active");
                    for (let i = 0; i < confguratorItem.closest(".main-configurator__list").querySelectorAll(".main-configurator__list-item").length; i++) confguratorItem.closest(".main-configurator__list").querySelectorAll(".main-configurator__list-item")[i].classList.remove("_active");
                    confguratorItem.classList.add("_active");
                    activeColumn.querySelector(".navigation-configurator__text").innerHTML = confguratorItem.querySelector(".main-configurator__title").textContent;
                    activeColumn.dataset.price = confguratorItem.dataset.price;
                    activeColumn.classList.remove("empty");
                }
                if (e.target.closest(".total-configurator__back")) {
                    const totalConfigurator = document.querySelector(".total-configurator");
                    const contentConfigurator = document.querySelectorAll(".content-configurator");
                    for (let i = 0; i < contentConfigurator.length; i++) contentConfigurator[i].classList.add("_active");
                    totalConfigurator.classList.remove("_active");
                }
            }));
            function totalActive() {
                const configuratorDesktop = document.querySelector(".content-configurator--desktop");
                const cpu = configuratorDesktop.querySelector("#cpu");
                const videoCard = configuratorDesktop.querySelector("#video");
                const motherboard = configuratorDesktop.querySelector("#motherboard");
                const ram = configuratorDesktop.querySelector("#ram");
                const ssd = configuratorDesktop.querySelector("#ssd");
                const hdd = configuratorDesktop.querySelector("#hdd");
                const power = configuratorDesktop.querySelector("#power");
                const cooling = configuratorDesktop.querySelector("#cooling");
                const os = configuratorDesktop.querySelector("#os");
                const keyboard = configuratorDesktop.querySelector("#keyboard");
                const mouse = configuratorDesktop.querySelector("#mouse");
                const monitor = configuratorDesktop.querySelector("#monitor");
                const sound = configuratorDesktop.querySelector("#sound");
                const headphones = configuratorDesktop.querySelector("#headphones");
                const armchair = configuratorDesktop.querySelector("#armchair");
                const cpuInput = document.getElementById("_cpu");
                const videoCardInput = document.getElementById("_video");
                const motherboardInput = document.getElementById("_motherboard");
                const ramInput = document.getElementById("_ram");
                const ssdInput = document.getElementById("_ssd");
                const hddInput = document.getElementById("_hdd");
                const powerInput = document.getElementById("_power");
                const coolingInput = document.getElementById("_cooling");
                const osInput = document.getElementById("_os");
                const keyboardInput = document.getElementById("_keyboard");
                const mouseInput = document.getElementById("_mouse");
                const monitorInput = document.getElementById("_monitor");
                const soundInput = document.getElementById("_sound");
                const headphonesInput = document.getElementById("_headphones");
                const armchairInput = document.getElementById("_armchair");
                cpuInput.innerHTML = cpu.textContent;
                videoCardInput.innerHTML = videoCard.textContent;
                motherboardInput.innerHTML = motherboard.textContent;
                ramInput.innerHTML = ram.textContent;
                ssdInput.innerHTML = ssd.textContent;
                hddInput.innerHTML = hdd.textContent;
                powerInput.innerHTML = power.textContent;
                coolingInput.innerHTML = cooling.textContent;
                osInput.innerHTML = os.textContent;
                keyboardInput.innerHTML = keyboard.textContent;
                mouseInput.innerHTML = mouse.textContent;
                monitorInput.innerHTML = monitor.textContent;
                soundInput.innerHTML = sound.textContent;
                headphonesInput.innerHTML = headphones.textContent;
                armchairInput.innerHTML = armchair.textContent;
            }
            function totalPrice() {
                const configuratorColumns = document.querySelector(".content-configurator--desktop").getElementsByClassName("navigation-configurator__column");
                const totalSum = document.querySelector(".total-configurator__total-price-sum");
                let x = 0;
                for (let i = 0; i < configuratorColumns.length; i++) x += Number(configuratorColumns[i].dataset.price);
                totalSum.innerHTML = x;
            }
            function configuratorListsActive() {
                const configuratorNavigationItems = document.querySelectorAll(".navigation-configurator__item");
                const configuratorColumns = document.querySelectorAll(".navigation-configurator__columns");
                const configuratorLists = document.querySelectorAll(".main-configurator__lists");
                let currentNavigationItemId;
                let columnId;
                for (let i = 0; i < configuratorNavigationItems.length; i++) {
                    if (i != configuratorNavigationItems.length - 1) configuratorLists[i].classList.remove("_active");
                    if (configuratorNavigationItems[i].classList.contains("_active")) currentNavigationItemId = i;
                }
                for (let i = 0; i < configuratorColumns[currentNavigationItemId].querySelectorAll(".navigation-configurator__column").length; i++) {
                    configuratorLists[currentNavigationItemId].querySelectorAll(".main-configurator__list")[i].classList.remove("_active");
                    if (configuratorColumns[currentNavigationItemId].querySelectorAll(".navigation-configurator__column")[i].classList.contains("_active")) columnId = i;
                }
                configuratorLists[currentNavigationItemId].classList.add("_active");
                configuratorLists[currentNavigationItemId].querySelectorAll(".main-configurator__list")[columnId].classList.add("_active");
            }
        }
        if (script_width <= 991.98) if (document.querySelector(".configurator")) document.addEventListener("click", (function(e) {
            if (e.target.closest(".content-configurator-rows__list-item")) {
                const listRow = e.target.closest(".content-configurator-rows__row");
                const listText = listRow.querySelector(".content-configurator-rows__text");
                listText.innerHTML = e.target.closest(".content-configurator-rows__list-item").querySelector(".content-configurator-rows__title").textContent;
                listRow.dataset.price = e.target.closest(".content-configurator-rows__list-item").dataset.price;
                listRow.classList.remove("empty");
                listRow.classList.add("active");
            }
            if (e.target.closest(".content-configurator__slide")) {
                const configuratorNavigationSlides = document.querySelectorAll(".content-configurator__slide");
                if (e.target.closest(".content-configurator__slide") != configuratorNavigationSlides[configuratorNavigationSlides.length - 1]) {
                    let currentNavigationSlideId;
                    const listRows = document.querySelectorAll(".content-configurator__rows");
                    for (let i = 0; i < configuratorNavigationSlides.length; i++) {
                        configuratorNavigationSlides[i].classList.remove("_active");
                        if (i != listRows.length) listRows[i].classList.remove("_active");
                        if (e.target.closest(".content-configurator__slide") == configuratorNavigationSlides[i]) currentNavigationSlideId = i;
                    }
                    e.target.closest(".content-configurator__slide").classList.add("_active");
                    listRows[currentNavigationSlideId].classList.add("_active");
                }
                if (e.target.closest(".content-configurator__slide") == configuratorNavigationSlides[configuratorNavigationSlides.length - 1]) {
                    const contentConfigurator = document.querySelectorAll(".content-configurator");
                    const totalConfigurator = document.querySelector(".total-configurator");
            ...
            function totalActive() {
                const configuratorTablet = document.querySelector(".content-configurator--tablet");
                const cpu = configuratorTablet.querySelector("#cpu");
                const videoCard = configuratorTablet.querySelector("#video");
                const motherboard = configuratorTablet.querySelector("#motherboard");
                const ram = configuratorTablet.querySelector("#ram");
                const ssd = configuratorTablet.querySelector("#ssd");
                const hdd = configuratorTablet.querySelector("#hdd");
                const power = configuratorTablet.querySelector("#power");
                const cooling = configuratorTablet.querySelector("#cooling");
                const os = configuratorTablet.querySelector("#os");
                const keyboard = configuratorTablet.querySelector("#keyboard");
                const mouse = configuratorTablet.querySelector("#mouse");
                const monitor = configuratorTablet.querySelector("#monitor");
                const sound = configuratorTablet.querySelector("#sound");
                const headphones = configuratorTablet.querySelector("#headphones");
                const armchair = configuratorTablet.querySelector("#armchair");
                const cpuInput = document.getElementById("_cpu");
                const videoCardInput = document.getElementById("_video");
                const motherboardInput = document.getElementById("_motherboard");
                const ramInput = document.getElementById("_ram");
            ...
            function totalPrice() {
                const configuratorRows = document.querySelector(".content-configurator--tablet").getElementsByClassName("content-configurator-rows__row");
                const totalSum = document.querySelector(".total-configurator__total-price-sum");
                let x = 0;
                for (let i = 0; i < configuratorRows.length; i++) x += Number(configuratorRows[i].dataset.price);
                totalSum.innerHTML = x;
            }
        }));
        window["FLS"] = true;
