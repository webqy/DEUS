(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-live__slider") && sliders_width > 1300.98) new core(".swiper-live__slider", {
        ...
        if (document.querySelector(".configuration__slider")) {
            const configurationSlider = document.querySelector(".configuration__slider");
            const configurationSlides = document.querySelectorAll(".configuration__slide");
            const configurationNavigation = document.querySelector(".configuration__navigation");
            const configurationTitle = document.querySelector(".configuration__title .title__text");
            if (configurationSlides.length > 4 && sliders_width > 1300.98) {
                configurationTitle.classList.add("after-none");
                configurationNavigation.style.display = "flex";
                configurationSlider.classList.add("_active-slider");
                configurationSlider.classList.remove("_disable-slider");
                new core(".configuration__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
            ...
            } else if (sliders_width <= 1300.98 && configurationSlides.length > 4) {
                configurationTitle.classList.add("after-none");
                if (sliders_width > 991.98) configurationNavigation.style.display = "flex";
                configurationSlider.classList.add("_active-slider");
                configurationSlider.classList.remove("_disable-slider");
                new core(".configuration__slider", {
                    modules: [ Navigation ],
            ...
            } else if (configurationSlides.length <= 4 && sliders_width > 991.98) {
                configurationTitle.classList.remove("after-none");
                configurationNavigation.style.display = "none";
                configurationSlider.classList.add("_disable-slider");
                configurationSlider.classList.remove("_active-slider");
            } else if (configurationSlides.length <= 4 && sliders_width <= 991.98) {
                configurationTitle.classList.remove("after-none");
                configurationNavigation.style.display = "none";
                configurationSlider.classList.add("_active-slider");
 ...
 */
    ...
    const products_namespaceObject = JSON.parse('{"R":[{"id":5,"url":"#","series":"optima","title":"Optima Lvl 1","type":"Игровой компьютер","image":"img/lineup/02.png","price":"1361","cpu":"AMD Ryzen 7 3700X 3.6-4.4GHz","videoCard":"Gigabyte RTX 2060 Super 8Gb","ram":"G.Skill RGB 2x8Gb 3200MHz","ssd":"XPG SX8200 Pro 512Gb M.2"},{"id":6,"url":"#","series":"optima","title":"Optima Lvl 2","type":"Игровой компьютер","image":"img/lineup/02.png","price":"1520","cpu":"AMD Ryzen 7 3700X 3.6-4.4GHz","videoCard":"Gigabyte RTX 2070 Super 8Gb","ram":"G.Skill RGB 2x8Gb 3200MHz","ssd":"XPG SX8200 Pro 512Gb M.2"},{"id":7,"url":"#","series":"optima","title":"Optima Lvl 3","type":"Игровой компьютер","image":"img/lineup/02.png","price":"1600","cpu":"AMD Ryzen 7 3700X 3.6-4.4GHz","videoCard":"Gigabyte RTX 2080 Super 8Gb","ram":"G.Skill RGB 2x8Gb 3200MHz","ssd":"XPG SX8200 Pro 512Gb M.2"},{"id":8,"url":"#","series":"optima","title":"Optima Lvl 4","type":"Игровой компьютер","image":"img/lineup/02.png","price":"1700","cpu":"AMD Ryzen 7 3700X 3.6-4.4GHz","videoCard":"Gigabyte RTX 2080 Ti 11Gb","ram":"G.Skill RGB 2x8Gb 3200MHz","ssd":"XPG SX8200 Pro 512Gb M.2"}]}');
    ...
    if (document.querySelector(".form-cart")) {
        ...
        function copyInputs() {
            ...
            if (document.querySelector(".form-cart").dataset.free) {
                document.querySelector(".form-confirmation__input-text--1").innerText = document.querySelector(".form-cart").dataset.free;
                document.querySelector(".form-confirmation__input-text--2").innerText = cityValue + ", " + homeValue + ", " + indexValue;
            } else {
                document.querySelector(".form-confirmation__input-text--1").innerText = "";
                document.querySelector(".form-confirmation__input-text--2").innerText = cityValue + ", " + homeValue + ", " + indexValue;
            }
        }
